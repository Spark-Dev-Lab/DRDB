export default {
    install(app) {
        app.config.globalProperties.$familyFields = [
            {
                label: "Email",
                field: "Email",
                rules: "email",
        ...
        app.config.globalProperties.$familyBasicInfo = [
            {
                label: "Primary Caregiver",
                field: "NamePrimary",
                rules: "name",
        ...
        app.config.globalProperties.$familyContactInfo = [
            {
                label: "Email",
                field: "Email",
                rules: "email",
        ...
        app.config.globalProperties.$childInfo = [
            {
                label: "Name",
                field: "Name",
                rules: "name",
        ...
        app.config.globalProperties.$childSensitiveInfo = [
        ...
        app.config.globalProperties.$labInfo = [
            {
                label: "Lab's Name",
                field: "LabName",
                rules: "required",
        ...
        app.config.globalProperties.$labPI = [
        ...
        app.config.globalProperties.$labEmailTemplate = [
        ...
        app.config.globalProperties.$studyPointofContact = [
            { label: "Name", field: "Name" },
            { label: "Email", field: "Email" },
            { label: "Phone", field: "Phone" },
        ];

        app.config.globalProperties.$studyBasicFields = [
        ...
        app.config.globalProperties.$studyTimeSlots = [
            "08:30AM",
            "09:00AM",
            "09:30AM",
            "10:00AM",
        ...
        app.config.globalProperties.$headersSchedule = [
            {
                text: "Child",
                align: "end",
                value: "Child",
        ...
        app.config.globalProperties.$headersAppointments = [
        ...
        app.config.globalProperties.$headersAppointmentsBrief = [
