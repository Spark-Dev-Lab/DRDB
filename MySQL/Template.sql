...
CREATE TABLE `Family` (
  ...
  `PrimaryGenderIdentity` varchar(50) DEFAULT NULL,
  `DoBPrimary` date DEFAULT NULL,
  `NameSecondary` varchar(50) DEFAULT NULL,
  `SecondaryGenderIdentity` varchar(50) DEFAULT NULL,
...
INSERT INTO `TestingRoom` VALUES (1,'test1','1','test1','test1','test1', '1','2023-02-16 16:01:47','2023-02-16 16:01:47', 0);
...
CREATE TABLE `Study` (
  ...
  `ASDParticipant` enum('Include','Exclude','Only','Not Applicable') NOT NULL DEFAULT 'Include',
  `PrematureParticipant` enum('Include','Exclude','Only','Not Applicable') NOT NULL DEFAULT 'Include',
  `VisionLossParticipant` enum('Include','Exclude','Only','Not Applicable') NOT NULL DEFAULT 'Include',
  `HearingLossParticipant` enum('Include','Exclude','Only','Not Applicable') NOT NULL DEFAULT 'Include',
  `IllParticipant` enum('Include','Exclude','Only','Not Applicable') NOT NULL DEFAULT 'Include',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
